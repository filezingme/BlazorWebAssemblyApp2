...
namespace TodoListBlazorWasm.Services
{
    public class AuthService : IAuthService
    {
        ...
        private readonly ILocalStorageService _localSorage;
            ...
            ILocalStorageService localStorageService)
        {
            ...
            _localSorage = localStorageService;
        ...
        public async Task<LoginResponse> Login(LoginRequest loginRequest)
        {
            ...
            await _localSorage.SetItemAsync("authToken", loginResponse.Token);
        ...
        {
            await _localSorage.RemoveItemAsync("authToken");
